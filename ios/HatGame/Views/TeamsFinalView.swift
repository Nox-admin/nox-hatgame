...
/// Финальный экран командного режима — итоговые результаты
struct TeamsFinalView: View {
    ...
    private func leaderboard(standings: [Team]) -> some View {
        VStack(spacing: 8) {
...
private struct TeamsConfettiView: View {
    @State private var particles: [TeamsConfettiParticle] = []
...
private struct TeamsConfettiParticle {
    let x: CGFloat
    let startY: CGFloat
